...
class RobotCommand(object):
    ...
    def off(self):
        ...
        actual_state = self.__req.getParameter(
            "root/Logic/state").get().value[0]
        ...
        if actual_state == States.OFF_S.value:
            ...
            self.__req.setParameter(
                "root/Logic/stateCommand", StateEvents.GOTO_OFF_E.value).get()
            ...
            self.__req.setParameter(
                "root/Logic/stateCommand", StateEvents.GOTO_DISENGAGED_E.value).get()
            self.__req.setParameter(
                "root/Logic/stateCommand", StateEvents.GOTO_OFF_E.value).get()
        else:
    ...
    def engage(self):
        ...
        if actual_state == States.ENGAGED_S.value:
            return True
                ...
                (actual_state == States.DISENGAGED_S.value):
            self.__req.setParameter(
                "root/Logic/stateCommand", StateEvents.GOTO_ENGAGED_E.value).get()
    ...
    def manualCartMode(self):
        ...
        if actual_mode == Modes.MANUAL_CART_MODE_M.value:
            ...
            self.__req.setParameter(
                "root/Logic/modeCommand", ModeCommands.GOTO_PAUSE_E.value).get()
            self.__req.setParameter(
                "root/Logic/modeCommand", ModeCommands.GOTO_MANUAL_CART_MODE_E.value).get()

        while actual_mode != Modes.MANUAL_CART_MODE_M.value:
            actual_mode = self.__req.getParameter(
                "root/Logic/mode").get().value[0]
            time.sleep(0.1)
        return True
    ...
    def manualJointMode(self):
        ...
        if actual_mode == Modes.MANUAL_JOINT_MODE_M.value:
            ...
            self.__req.setParameter(
                "root/Logic/modeCommand", ModeCommands.GOTO_MANUAL_JOINT_MODE_E.value).get()
    ...
    def autoMode(self, timeout=2):
        ...
        if actual_mode == Modes.AUTO_RUN_M.value:
            ...
            self.__req.setParameter(
                "root/Logic/modeCommand", ModeCommands.GOTO_PAUSE_E.value).get()
            self.__req.setParameter(
                "root/Logic/modeCommand", ModeCommands.GOTO_AUTO_RUN_E.value).get()
    ...
    def semiAutoMode(self):
        ...
        if actual_mode == Modes.SEMI_AUTO_M.value:
            ...
            self.__req.setParameter(
                "root/Logic/modeCommand", ModeCommands.GOTO_PAUSE_E.value).get()
            self.__req.setParameter(
                "root/Logic/modeCommand", ModeCommands.GOTO_SEMI_AUTO_E.value).get()
    ...
    def moveToPoint(self, target_joint_coord_rad, v_max=0.5, a_max=1.0):
        ...
        if self.semiAutoMode():
            ...
            self.__req.setParameter(
                "root/Control/activateSemiAuto", True).get()
            while True:
                motion_not_done = \
                ...
                if not motion_not_done:
                    self.__req.setParameter(
                        "root/Control/activateSemiAuto", False).get()
                    self.autoMode()
                    return True
                time.sleep(0.1)
    ...
    def getTypesRef(self):
        return self.__motorcortex_types
